...
namespace WebApiAuthorization.Helper_Code.Common
{
    ...
    public class AuthorizationHeaderHandler : DelegatingHandler
    {
        ...
        protected override Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            // Verification.   
            if (request.Headers.TryGetValues(ApiInfo2.API_KEY_HEADER, out apiKeyHeaderValues) && !string.IsNullOrEmpty(authorization.Parameter))
            {
                ...
                // Verification.   
                if (apiKeyHeaderValue.Equals(ApiInfo2.API_KEY_VALUE) && userName.Equals(ApiInfo2.USERNAME_VALUE) && password.Equals(ApiInfo2.PASSWORD_VALUE))
                {
                    // Setting   
